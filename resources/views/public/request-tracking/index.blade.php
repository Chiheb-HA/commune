...
@section('page-title', __('messages.Request Tracking'))
@section('title', __('messages.Request Tracking'))
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">{{ __('messages.Track Request') }}</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('request-tracking.search') }}">
                        @csrf
